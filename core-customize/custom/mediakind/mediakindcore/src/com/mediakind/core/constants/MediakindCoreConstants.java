 ...
 */
package com.mediakind.core.constants;

/**
 * Global class for all MediakindCore constants. You can add global constants for your extension into this class.
 */
public final class MediakindCoreConstants extends GeneratedMediakindCoreConstants
{
	public static final String EXTENSIONNAME = "mediakindcore";


	private MediakindCoreConstants()
	{
		//empty
	}
