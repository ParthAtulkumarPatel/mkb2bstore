 ...
 */
package com.mediakind.fulfilmentprocess.test.actions;
...
public class SplitOrder extends TestActionTemp
{
	...
	public String execute(final BusinessProcessModel process) throws Exception
	{
		...
		warehouseCounter.setName(MediakindFulfilmentProcessConstants.CONSIGNMENT_COUNTER);
		...
		params.setName(MediakindFulfilmentProcessConstants.PARENT_PROCESS);
