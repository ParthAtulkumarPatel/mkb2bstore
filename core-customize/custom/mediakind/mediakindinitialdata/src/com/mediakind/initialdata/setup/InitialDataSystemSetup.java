 ...
 */
package com.mediakind.initialdata.setup;
 ...
 */
@SystemSetup(extension = MediakindInitialDataConstants.EXTENSIONNAME)
public class InitialDataSystemSetup extends AbstractSystemSetup
{
	...
	public void createProjectData(final SystemSetupContext context)
	{
		...
		final ImportData sampleImportData = new ImportData();
		sampleImportData.setProductCatalogName(MEDIAKIND);
		sampleImportData.setContentCatalogNames(Arrays.asList(MEDIAKIND));
		sampleImportData.setStoreNames(Arrays.asList(MEDIAKIND));
		importData.add(sampleImportData);
