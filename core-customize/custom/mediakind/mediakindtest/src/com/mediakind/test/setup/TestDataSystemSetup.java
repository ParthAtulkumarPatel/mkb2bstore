 ...
 */
package com.mediakind.test.setup;
...
import com.mediakind.test.constants.MediakindTestConstants;
import com.mediakind.test.orders.AcceleratorTestOrderData;
 ...
 */
@SystemSetup(extension = MediakindTestConstants.EXTENSIONNAME)
public class TestDataSystemSetup extends AbstractSystemSetup
{
	...
	public void createProjectData(final SystemSetupContext context)
	{
		if (getBooleanSystemSetupParameter(context, CREATE_TEST_DATA))
		{
			...
			importImpexFile(context, "/mediakindtest/import/qa-test-users.impex");

			LOG.info("Creating Reviews...");
			importImpexFile(context, "/mediakindtest/import/reviews.impex");

			LOG.info("Creating Test Payment Subscriptions...");
			getAcceleratorTestOrderData().createPaymentInfos();

			LOG.info("Creating CS Tickets...");
			importImpexFile(context, "/mediakindtest/import/cstickets.impex");
			...
			importImpexFile(context, "/mediakindtest/import/csquotes.impex");
		}
	}
}
