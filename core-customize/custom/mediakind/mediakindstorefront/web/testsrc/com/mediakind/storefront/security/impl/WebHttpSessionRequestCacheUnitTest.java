...
public class WebHttpSessionRequestCacheUnitTest
{
	...
	public void testCalcRedirectUrlWithEncodingAttrs()
	{
		assertEquals(
				"/",
				executeCalculateRelativeRedirectUrl("electronics/en", "/mediakindstorefront/electronics/en",
						"https://electronics.local:9002/mediakindstorefront/electronics/en"));
		assertEquals(
				"/",
				executeCalculateRelativeRedirectUrl("electronics/en", "/mediakindstorefront/electronics/en",
						"https://electronics.local:9002/mediakindstorefront/electronics/en/"));
	...
	public void testCalcRedirectUrlWithMismatchEncodingAttrs()
	{
		assertEquals(
				"electronics/en",
				executeCalculateRelativeRedirectUrl("electronics/ja/Y/Z", "/mediakindstorefront/electronics/ja/Y/Z",
						"https://electronics.local:9002/mediakindstorefront/electronics/en"));
		assertEquals(
				"/",
				executeCalculateRelativeRedirectUrl("electronics/ja/Y/Z", "/mediakindstorefront/electronics/en",
						"https://electronics.local:9002/mediakindstorefront/electronics/en/"));
	}
	...
	public void testCalcRedirectUrlWithoutEncodingAttrs()
	{
		assertEquals(
				"/",
				executeCalculateRelativeRedirectUrl("", "/mediakindstorefront",
						"https://electronics.local:9002/mediakindstorefront"));
		assertEquals(
				"/",
				executeCalculateRelativeRedirectUrl("", "/mediakindstorefront",
						"https://electronics.local:9002/mediakindstorefront/"));
	...
	public void testCalcRedirectUrlWithEncodingAttrsServletPath()
	{
		assertEquals(
				...
				executeCalculateRelativeRedirectUrl("electronics/en", "/mediakindstorefront/electronics/en",
						"https://electronics.local:9002/mediakindstorefront/electronics/en/Open-Catalogue/Cameras/Digital-Cameras/c/575"));
	}
